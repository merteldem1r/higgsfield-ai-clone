...
const PILL = "flex h-9 shrink-0 items-center gap-2 rounded-full border px-3.5 text-sm font-medium";

export function ModelChips() {
  return (
    <ul
      aria-label="Models"
      className="-mx-4 flex gap-2 overflow-x-auto px-4 [scrollbar-width:none] sm:mx-0 sm:justify-center sm:px-0"
    >
